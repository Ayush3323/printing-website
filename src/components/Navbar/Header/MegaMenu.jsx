  ...
  return (
    <div className="absolute left-0 top-full w-full bg-white border-t shadow-md z-50 overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-6 py-8 flex gap-8 text-[13px]">
        ...
        {/* Hover Query / Product Preview (Visual enhancement) */}
        {hoveredLink && (
          <div className="w-64 hidden lg:block bg-gray-50 rounded-lg p-4 h-full border border-gray-100 flex flex-col">
            <div className="aspect-square bg-white rounded-md mb-3 flex items-center justify-center overflow-hidden relative border border-gray-100">
              {hoveredLink.image ? (
                <img
      ...
      {/* Footer Link if available - passed differently now, check data structure */}
    </div>
  );
};
